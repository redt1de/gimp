...
|----------|-----------------------|-------------|-------|-------|----------------|
| [![v8](https://github.com/jcmturner/gokrb5/workflows/v8/badge.svg)](https://github.com/jcmturner/gokrb5/actions?query=workflow%3Av8) | Go modules | import "github.com/redt1de/gimp/pkg/gokrb5/{sub-package}" | [![Usage](https://img.shields.io/badge/v8-usage-blue)](https://github.com/jcmturner/gokrb5/blob/master/v8/USAGE.md) | [![GoDoc](https://img.shields.io/badge/godoc-reference-blue)](https://pkg.go.dev/github.com/redt1de/gimp/pkg/gokrb5) | [![Go Report Card](https://goreportcard.com/badge/github.com/redt1de/gimp/pkg/gokrb5)](https://goreportcard.com/report/github.com/redt1de/gimp/pkg/gokrb5) |
