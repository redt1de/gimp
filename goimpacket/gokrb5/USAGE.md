...
relevant method:
```go
import "github.com/redt1de/gimp/pkg/gokrb5/config"
...
```go
import 	"github.com/redt1de/gimp/pkg/gokrb5/keytab"
...
```go
import 	"github.com/redt1de/gimp/pkg/gokrb5/client"
...
```go
import 	"github.com/redt1de/gimp/pkg/gokrb5/service"
